...
class FCMService extends PushService_1.BasePushService {
    constructor(config) {
        super(config);
     ...
     * 创建 JWT
     */
    async createJWT(clientEmail, privateKey, now) {
        // 简化的 JWT 实现
                ...
                body: JSON.stringify({
                    message: {
                        ...
                        data: notification.data ?
                            Object.fromEntries(Object.entries(notification.data).map(([k, v]) => [k, String(v)])) : undefined,
                        android: {
